...
s1 = ; % Signal 1 centré : N trials x n observations
s2 = ; % Signal 2 centré: N trials x n observations
rate =  ; % Frequency
n = size(s1,2) ; % Number of observation
N = size(s1,1) ; % Number of trials
dt = 1/rate ; % Période d'échantillonnage
T = n / rate ; % Durée totale en seconde
t = linspace(0,T,rate*T) ; % Time vector
% ----- Paramètres WaveCrossSpec
nvoice = ;
J1 = ;
wavenumber = ;
alpha = 0.05 ;
